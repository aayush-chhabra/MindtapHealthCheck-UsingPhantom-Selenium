function dashboard(id, fData) {
    ...
    function segColor(c) {
        return {
            Login: "#807dba",
            Dashboard: "#e08214",
            CourseAverage: "#41ab5d",
            MindappAverage: "#EF7581",
            ReadingActivity: "#CCF279"
        }[c];
    }
    ...
    return new Promise(function(fulfill, reject) {
        ...
        getLocations().then(function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                var courses = Object.keys(coursesDashboard);
                //console.log(courses);
                var coursesTotal=0;
                for(var j=0;j<courses.length; j++){
                    //console.log(coursesDashboard[courses[j]]);
                    coursesTotal += parseInt(coursesDashboard[courses[j]]);
                }
                coursesTotal = coursesTotal / courses.length;
                coursesTotal = Math.floor(coursesTotal);

                //---
                
                coursesDashboard = data[i]["mindapps"];
                courses = Object.keys(coursesDashboard);
                //console.log(courses);
                var mindappTotal=0;
                for(var j=0;j<courses.length; j++){
                    //console.log(coursesDashboard[courses[j]]);
                ...
                mindappTotal = Math.floor(mindappTotal);
